class GameStatus(object):
    ...
    def checkGameStatus(self, player): #player is an object
        ...
        if player.accBal >= 3000:
            print("Congratulations You have won the game! As your account balance is greater than or equal to R 3000")
            self.endGame = True
        elif player.accBal <= 0:
            print("Your account balance is less than or equal to R0, You have lost")
            self.endGame = True
        else:
            self.endGame = False
